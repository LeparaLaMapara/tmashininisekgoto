...
Part of that path was a first working pattern for getting data out of our on premises
databases and into the cloud environment and catalog over JDBC, which is simply the
standard way applications and data systems connect to relational databases. I built the
first one, proved it on real work, wrote it down and taught it. The point was never for
me to become the person who moves every dataset. It was that the next person should not
have to solve it again from scratch.
